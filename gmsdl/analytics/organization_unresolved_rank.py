...
def rank_unresolved(reclassification: Path, adjudication_v3: Path, adjudication_v4: Path, adjudication_v5: Path, adjudication_v6: Path, adjudication_v7: Path, out_dir: Path) -> dict:
...
def main() -> int:
    ...
    a=p.parse_args()
    print(json.dumps(rank_unresolved(a.reclassification,a.adjudication_v3,a.adjudication_v4,a.adjudication_v5,a.adjudication_v6,a.adjudication_v7,a.out_dir),indent=2,sort_keys=True,default=str))
    return 0
